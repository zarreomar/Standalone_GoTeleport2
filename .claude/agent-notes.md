...
### Before Deploying
1. Copy `ansible/group_vars/all.yml.example` → `ansible/group_vars/all.yml`
2. Customize variables (public_domain, IPs, subnets)
...
1. **Deployment Phase:** User will deploy to remote server using Ansible playbook
